    ...
    html: `
      <div style="font-family: 'Poppins', 'Segoe UI', Arial, sans-serif; background: #f5f7f6; padding: 24px; color: #333333;">
        <div style="max-width: 560px; margin: 0 auto; background: #ffffff; border: 1px solid #e0e0e0; border-radius: 16px; overflow: hidden; box-shadow: 0 12px 28px rgba(27, 94, 32, 0.08);">
          ...
          <div style="padding: 24px;">
            <p style="margin: 0 0 8px; font-size: 12px; letter-spacing: 0.08em; text-transform: uppercase; color: #757575;">IssueFixu</p>
            <h2 style="margin: 0 0 12px; color: #1b5e20; font-size: 24px; line-height: 1.3;">Verify your sign in</h2>
            <p style="line-height: 1.65; margin: 0 0 14px; color: #333333;">
              Use the verification code below to complete your IssueFixu sign in.
            </p>
            <div style="margin: 0 0 16px; padding: 14px; border-radius: 12px; background: #f1f8f2; border: 1px solid #d9eadb; text-align: center;">
              <p style="margin: 0; font-size: 30px; font-weight: 700; letter-spacing: 6px; color: #1b5e20;">
                ${params.code}
              </p>
            </div>
            <p style="font-size: 12px; color: #757575; line-height: 1.6; margin: 0;">
              This code expires in ${params.expiresInMinutes} minutes.
            </p>
            <p style="font-size: 12px; color: #757575; line-height: 1.6; margin: 8px 0 0;">
